...
Vue.component("cart", {
  ...
  <div>
  <div class="cart">
              <button class="header-cartbtn" @click="showCart = !showCart">
                <img src="img/cart.svg" alt="" class="header-cart" />
              </button>
              <div class="cart-block" v-show="showCart">
            <cart-item v-for="item of cartItems" :key="item.id_product" :img="img" :cart-item="item" @remove="remove">
            </cart-item>
        </div>
              </div>
